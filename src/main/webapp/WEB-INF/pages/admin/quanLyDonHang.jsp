...
<body>
	...
	<div class="col-md-9 animated bounce">
		...
		<hr />
		<a href="admin/export/execl" style="text-decoration: none;color: #FFFFFF;font-size: 14px;border-radius: 5px; background-color: #008000;padding: 9px 12px;margin-bottom: 10px;">Xuất excel</a><br>
