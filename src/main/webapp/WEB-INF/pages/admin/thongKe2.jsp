  ...
  <body>
    ...
    <div class="col-md-9 animated bounce">
      <h3 class="page-header">
        <b>Thống kê top 5 sản phẩm có số lượng bán chạy</b>
      </h3>
      ...
      <h4 style="text-align: center; padding-right: 10%; color: #d2691e">
        <b>Top 5 sản phẩm có số lượng bán chạy</b>
      </h4>
    </div>
    ...
    <script>
      ...
      window.onload = function () {
        ...
        $.ajax({
          ...
          url:
            "http://localhost:8080/swispshop/api/don-hang/report/so-luong-theo-san-pham/" +
            month,
