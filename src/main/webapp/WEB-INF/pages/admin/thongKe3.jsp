...
<html>
  <head>
    ...
    <title>Top 4 Doanh Thu Của Nhân Viên Theo Tháng</title>
  ...
  <body>
    ...
    <div class="col-md-9 animated bounce">
      <h3 class="page-header">
        <b
          >Thống kê top 4 nhân viên có doanh thu đơn hàng cao nhất trong
          tháng</b
        >
      </h3>
      ...
      <h4 style="text-align: center; padding-right: 10%; color: #d2691e">
        <b>Top 4 nhân viên có doanh thu đơn hàng cao nhất trong tháng</b>
      </h4>
    </div>
    ...
    <script>
      ...
      window.onload = function () {
        ...
        $.ajax({
          ...
          url:
            "http://localhost:8080/swispshop/api/don-hang/report/top4DoanhThuCuaNhanVienTheoThang/" +
            month,
