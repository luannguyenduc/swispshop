  ...
  <body>
    ...
    <div class="col-md-9 animated bounce">
      <h3 class="page-header">
        <b>Thống kê top 10 doanh thu sản phẩm bán chạy theo tháng</b>
      </h3>
      ...
      <h1><canvas id="myChart"></canvas></h1>
      <h4 style="text-align: center; padding-right: 10%; color: #d2691e">
        <b>Top 10 doanh thu sản phẩm bán chạy theo tháng</b>
      </h4>
    </div>
    ...
    <script>
      ...
      window.onload = function () {
        ...
        $.ajax({
          ...
          url:
            "http://localhost:8080/swispshop/api/don-hang/report/doanh-thu-theo-san-pham/" +
            month,
