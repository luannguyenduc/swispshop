$(document).ready(function () {
  ...
  function ajaxGet(page) {
    $.ajax({
      type: "GET",
      url: "http://localhost:8080/swispshop/api/nhan-hieu/all?page=" + page,
  ...
  function ajaxPost() {
    ...
    $.ajax({
      ...
      url: "http://localhost:8080/swispshop/api/nhan-hieu/save",
  ...
  $(document).on("click", ".btnCapNhatNhanHieu", function () {
    ...
    $("#form #btnSubmit")
      .removeClass()
      .addClass("btn btn-primary btnUpdateForm");
    var href = "http://localhost:8080/swispshop/api/nhan-hieu/" + nhanHieuId;
  ...
  function ajaxPut() {
    ...
    $.ajax({
      ...
      type: "PUT",
      contentType: "application/json",
      url: "http://localhost:8080/swispshop/api/nhan-hieu/update",
      data: JSON.stringify(formData),
      // dataType : 'json',
      success: function (response) {
        if (response.status == "success") {
  ...
  $(document).on("click", ".btnXoaNhanHieu", function () {
    ...
    if (confirmation) {
      $.ajax({
        type: "DELETE",
        url:
          "http://localhost:8080/swispshop/api/nhan-hieu/delete/" + nhanHieuId,
